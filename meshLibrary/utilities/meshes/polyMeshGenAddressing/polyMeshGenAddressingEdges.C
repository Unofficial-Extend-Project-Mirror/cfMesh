...
void Foam::Module::polyMeshGenAddressing::calcEdges() const
{
    if (edgesPtr_)
    {
...
const Foam::edgeList& Foam::Module::polyMeshGenAddressing::edges() const
{
    if (!edgesPtr_)
    {
        # ifdef USE_OMP
...
void Foam::Module::polyMeshGenAddressing::clearOutEdges()
{
