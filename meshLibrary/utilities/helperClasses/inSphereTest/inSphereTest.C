...
#include "error.H"
#include "inSphereTest.H"
#include "helperFunctions.H"

namespace Foam
{

void inSphereTest::calculateIntersections()
{
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *//
// Member functions
direction inSphereTest::triInfluence() const
{
    return influence_;
}

const boolList& inSphereTest::intersectedPoints() const
{
    return intersectedPoints_;
}

const pointField& inSphereTest::edgePoints() const
{
    return edgePoints_;
}

const boolList& inSphereTest::intersectedEdges() const
{
    return intersectedEdges_;
}

label inSphereTest::determineRotation
(
...
bool inSphereTest::edgePointInsideFace
(
    const face& f,
    const vector& n,
    const pointField& fp,
...
bool inSphereTest::pointInsideFace
(
    const face& f,
    const vector& n,
    const pointField& fp,
